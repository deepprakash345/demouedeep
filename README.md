...
## Environments
- Preview: https://main--demouedeep--deepprakash345.hlx.page/
- Live: https://main--demouedeep--deepprakash345.hlx.live/
...
1. Open the `demouedeep` directory in your favorite IDE and start coding :)
